...
**businessName** | **string** | Business name. Required when the recipient of the form is a business; should only be used for businesses. | [optional] [default to undefined]
**businessName2** | **string** | Business name line 2. Should only be used for businesses. | [optional] [default to undefined]
...
**suffixName** | **string** | Suffix name. Should only be used for individuals. | [optional] [default to undefined]
