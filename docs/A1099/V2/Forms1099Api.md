...
# **create1099Form**
> FormResponseBase create1099Form (string avalaraVersion, string xCorrelationId, ICreateForm1099Request iCreateForm1099Request)
...
# **get1099Form**
> FormResponseBase get1099Form (string id, string avalaraVersion, string xCorrelationId)
 ...
 **$orderBy** | **string**| A comma separated list of sort statements in the format (fieldname) [ASC|DESC], for example issuerReferenceId ASC.    Supported sorting fields are:         issuerReferenceId       taxYear       createdAt       firstPayeeName      updatedAt | [optional] [default to undefined]
