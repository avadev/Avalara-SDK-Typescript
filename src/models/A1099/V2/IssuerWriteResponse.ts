...
export interface IssuerWriteResponse {
     ...
     * @memberof IssuerWriteResponse
     */
    tinType?: IssuerWriteResponseTinTypeEnum;
    /**
...
* @enum {string}
*/
export enum IssuerWriteResponseTinTypeEnum {
    Unknown = 'UNKNOWN',
...
/**
 * Check if a given object implements the IssuerWriteResponse interface.
 */
export function instanceOfIssuerWriteResponse(value: object): boolean {
    let isInstance = true;
...
export function IssuerWriteResponseFromJSON(json: any): IssuerWriteResponse {
    return IssuerWriteResponseFromJSONTyped(json, false);
}

export function IssuerWriteResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IssuerWriteResponse {
...
export function IssuerWriteResponseToJSON(value?: IssuerWriteResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
