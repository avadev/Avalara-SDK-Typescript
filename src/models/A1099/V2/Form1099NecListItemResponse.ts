 ...
 * 
 * @export
 * @interface Form1099NecListItemResponse
 */
export interface Form1099NecListItemResponse {
    /**
     * Nonemployee compensation
     * @type {number}
     * @memberof Form1099NecListItemResponse
     */
...
/**
 * Check if a given object implements the Form1099NecListItemResponse interface.
 */
export function instanceOfForm1099NecListItemResponse(value: object): boolean {
    let isInstance = true;
...
export function Form1099NecListItemResponseFromJSON(json: any): Form1099NecListItemResponse {
    return Form1099NecListItemResponseFromJSONTyped(json, false);
}

export function Form1099NecListItemResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Form1099NecListItemResponse {
...
export function Form1099NecListItemResponseToJSON(value?: Form1099NecListItemResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
