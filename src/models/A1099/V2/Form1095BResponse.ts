 ...
 * 
 * @export
 * @interface Form1095BResponse
 */
export interface Form1095BResponse {
    /**
     * 
     * @type {string}
     * @memberof Form1095BResponse
     */
     ...
     * @memberof Form1095BResponse
     */
    originOfHealthCoverageCode?: Form1095BResponseOriginOfHealthCoverageCodeEnum;
    /**
     * 
     ...
     * @memberof Form1095BResponse
     */
    readonly type?: Form1095BResponseTypeEnum;
    /**
     * 
     * @type {Date}
     * @memberof Form1095BResponse
     ...
     * @memberof Form1095BResponse
     */
    tinType?: Form1095BResponseTinTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof Form1095BResponse
...
* @enum {string}
*/
export enum Form1095BResponseOriginOfHealthCoverageCodeEnum {
    A = 'A',
    B = 'B',
    C = 'C',
    D = 'D',
...
* @enum {string}
*/
export enum Form1095BResponseTypeEnum {
    _1099Nec = '1099-NEC',
    _1099Misc = '1099-MISC',
    _1099Div = '1099-DIV',
    _1099R = '1099-R',
...
* @enum {string}
*/
export enum Form1095BResponseTinTypeEnum {
    Ein = 'EIN',
    Ssn = 'SSN',
    Itin = 'ITIN',
    Atin = 'ATIN'
...
/**
 * Check if a given object implements the Form1095BResponse interface.
 */
export function instanceOfForm1095BResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function Form1095BResponseFromJSON(json: any): Form1095BResponse {
    return Form1095BResponseFromJSONTyped(json, false);
}

export function Form1095BResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Form1095BResponse {
...
export function Form1095BResponseToJSON(value?: Form1095BResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
