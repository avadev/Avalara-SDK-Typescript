 ...
 * 
 * @export
 * @interface IrisFormBase
 */
export interface IrisFormBase {
    /**
     * Form type.
     * @type {string}
     * @memberof IrisFormBase
     */
    type: IrisFormBaseTypeEnum;
    /**
     ...
     * @memberof IrisFormBase
     */
    tinType?: IrisFormBaseTinTypeEnum;
    /**
...
* @enum {string}
*/
export enum IrisFormBaseTypeEnum {
    _1042S = '1042-S',
    _1095B = '1095-B',
    _1095C = '1095-C',
    _1099Div = '1099-DIV',
...
* @enum {string}
*/
export enum IrisFormBaseTinTypeEnum {
    Ein = 'EIN',
    Ssn = 'SSN',
    Itin = 'ITIN',
    Atin = 'ATIN',
...
/**
 * Check if a given object implements the IrisFormBase interface.
 */
export function instanceOfIrisFormBase(value: object): boolean {
    let isInstance = true;
...
export function IrisFormBaseFromJSON(json: any): IrisFormBase {
    return IrisFormBaseFromJSONTyped(json, false);
}

export function IrisFormBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IrisFormBase {
...
export function IrisFormBaseToJSON(value?: IrisFormBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
