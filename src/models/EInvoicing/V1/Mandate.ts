...
import {
    ...
    SupportedDocumentStatusesFromJSON,
    SupportedDocumentStatusesFromJSONTyped,
    SupportedDocumentStatusesToJSON,
} from './SupportedDocumentStatuses';
import {
    WorkflowIds,
    WorkflowIdsFromJSON,
...
export interface Mandate {
     ...
     * @type {Array<SupportedDocumentStatuses>}
     * @memberof Mandate
     */
    supportedDocumentStatuses?: Array<SupportedDocumentStatuses>;
}
...
export function MandateFromJSONTyped(json: any, ignoreDiscriminator: boolean): Mandate {
    ...
    return {
        ...
        'supportedDocumentStatuses': !exists(json, 'supportedDocumentStatuses') ? undefined : ((json['supportedDocumentStatuses'] as Array<any>)?.map(SupportedDocumentStatusesFromJSON)),
    };
}
...
export function MandateToJSON(value?: Mandate | null): any {
    ...
    return {
        ...
        'supportedDocumentStatuses': value.supportedDocumentStatuses === undefined ? undefined : ((value.supportedDocumentStatuses as Array<any>)?.map(SupportedDocumentStatusesToJSON)),
    };
}
