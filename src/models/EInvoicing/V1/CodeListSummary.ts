...
/**
 * Check if a given object implements the CodeListSummary interface.
 */
export function instanceOfCodeListSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CodeListSummaryFromJSON(json: any): CodeListSummary {
    return CodeListSummaryFromJSONTyped(json, false);
}

export function CodeListSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CodeListSummary {
...
export function CodeListSummaryToJSON(value?: CodeListSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
