...
import {
    ...
    RealTimeTinMatchResponseFromJSON,
...
export class TINMatchesApi extends runtime.ApiClient {
     ...
     * Perform real time TIN Match
     */
    async performRealTimeTinMatchRaw(requestParameters: PerformRealTimeTinMatchInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<RealTimeTinMatchResponse>, logObject: LogObject }> {
        ...
        if (requestParameters.avalaraVersion === null || requestParameters.avalaraVersion === undefined) {
            throw new runtime.RequiredError('avalaraVersion','Required parameter requestParameters.avalaraVersion was null or undefined when calling performRealTimeTinMatch.');
        }
        ...
        const { response, logObject } = await this.request({
            path: `/tin-matches/$real-time`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: RealTimeTinMatchRequestToJSON(requestParameters.realTimeTinMatchRequest),
        }, initOverrides, requiredScopes, false, runtime.AvalaraMicroservice.A1099);
        logObject.populateResponseInfo(response);
        return { response: new runtime.JSONApiResponse(response, (jsonValue) => RealTimeTinMatchResponseFromJSON(jsonValue)), logObject };
    }
