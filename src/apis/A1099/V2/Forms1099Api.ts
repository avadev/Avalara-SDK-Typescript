...
export class Forms1099Api extends runtime.ApiClient {
    ...
    async bulkUpsert1099FormsRaw(requestParameters: BulkUpsert1099FormsOperationInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<Form1099ProccessResult>, logObject: LogObject }> {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling bulkUpsert1099Forms.');
        }
     ...
     * Creates a 1099 form.
     */
    async create1099FormRaw(requestParameters: Create1099FormInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<FormResponseBase>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '2.0';
        if (requestParameters.avalaraVersion === null || requestParameters.avalaraVersion === undefined) {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling create1099Form.');
        }
        ...
        logObject.populateResponseInfo(response);
        return { response: new runtime.JSONApiResponse(response, (jsonValue) => FormResponseBaseFromJSON(jsonValue)), logObject };
    }

    /**
     * Creates a 1099 form.
     */
    async create1099Form(requestParameters: Create1099FormInterface, initOverrides?: RequestInit): Promise<FormResponseBase> {
    ...
    async delete1099FormRaw(requestParameters: Delete1099FormInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<void>, logObject: LogObject }> {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling delete1099Form.');
        }
     ...
     */
    async get1099FormRaw(requestParameters: Get1099FormInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<FormResponseBase>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '2.0';
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling get1099Form.');
        }
     ...
     * Retrieves a 1099 form.
     */
    async get1099Form(requestParameters: Get1099FormInterface, initOverrides?: RequestInit): Promise<FormResponseBase> {
     ...
     */
    async get1099FormPdfRaw(requestParameters: Get1099FormPdfInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<FormResponseBase>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '2.0';
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling get1099FormPdf.');
        }
     ...
     * Retrieves the PDF file for a single 1099 by form id.
     */
    async get1099FormPdf(requestParameters: Get1099FormPdfInterface, initOverrides?: RequestInit): Promise<FormResponseBase> {
    ...
    async list1099FormsRaw(requestParameters: List1099FormsInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<Form1099List>, logObject: LogObject }> {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling list1099Forms.');
        }
     ...
     * Updates a 1099 form.
     */
    async update1099FormRaw(requestParameters: Update1099FormInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<FormResponseBase>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '2.0';
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        if (requestParameters.xCorrelationId === null || requestParameters.xCorrelationId === undefined) {
            throw new runtime.RequiredError('xCorrelationId','Required parameter requestParameters.xCorrelationId was null or undefined when calling update1099Form.');
        }
     ...
     * Updates a 1099 form.
     */
    async update1099Form(requestParameters: Update1099FormInterface, initOverrides?: RequestInit): Promise<FormResponseBase> {
