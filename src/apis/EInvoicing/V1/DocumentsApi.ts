...
export interface FetchDocumentsOperationInterface {
    avalaraVersion?: string;
...
export class DocumentsApi extends runtime.ApiClient {
    ...
    async downloadDocumentRaw(requestParameters: DownloadDocumentInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<Blob>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '1.3';
     ...
     */
    async fetchDocumentsRaw(requestParameters: FetchDocumentsOperationInterface, initOverrides?: RequestInit): Promise<{ response: runtime.ApiResponse<DocumentFetch>, logObject: LogObject }> {
        requestParameters.avalaraVersion = requestParameters.avalaraVersion || '1.3';
        if (requestParameters.avalaraVersion === null || requestParameters.avalaraVersion === undefined) {
     ...
     * Fetch the inbound document from a tax authority
     */
    async fetchDocuments(requestParameters: FetchDocumentsOperationInterface, initOverrides?: RequestInit): Promise<DocumentFetch> {
